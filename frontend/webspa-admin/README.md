...
* [CoreUI Free Angular Admin Template](https://github.com/coreui/webspa-admin)
...
- [Download the latest release](https://github.com/coreui/webspa-admin/)
- Clone the repo: `git clone https://github.com/coreui/webspa-admin.git`
...
|   |   |       └── _nav.js      # sidebar navigation cfg
...
See [the Releases section of our project](https://github.com/coreui/webspa-admin/releases) for changelogs for each release version.
