# Harness Capsule: supervisor-20260513T113444Z-7a25e03c

Generated: 2026-05-13T11:34:44Z
...
```json
{
  "branch": "agent/codex/admin-sentry-peer-20260513-112040",
  "branches": [
    ...
    "agent/codex/admin-sentry-peer-20260513-112040 6f34f7e ",
    ...
    "main 6f34f7e origin/main",
    "slice/TIMWE-CI-001-add-build-test-ci fd5214f origin/slice/TIMWE-CI-001-add-build-test-ci"
  ],
  "dirty": true,
  "head": "6f34f7e",
  "inside_git": true,
  "status_porcelain": "M .agent/events.jsonl\n M .agent/tasks.json\n M frontend/webspa-admin/package-lock.json\n M frontend/webspa-admin/package.json\n M frontend/webspa-admin/src/app/app.module.ts\n M frontend/webspa-admin/src/main.ts\n?? .agent/heartbeats/TMP-064.json\n?? .agent/sessions/codex-admin-sentry-peer-20260513-112040/\n?? agent/backlog/issues/TMP-064-admin-sentry-angular18-peer.md\n?? agent/state/TMP-064.handoff.json\n?? agent/state/TMP-064.work-order.json",
